...
`HOSO_DATA_ROOT`. The application does not require source changes when the data
root changes. Production PDFs, runtime databases, logs, and local configuration
...
```bash
python -m app.cli process "input/<person-folder>"
```
